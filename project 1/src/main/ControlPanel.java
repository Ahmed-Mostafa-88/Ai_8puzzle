...
public class ControlPanel extends JPanel implements ActionListener{
    ...
    JRadioButton dfs;
    JRadioButton bfs;
    JRadioButton aStar,aStarManhattan, aStarEuclid;
    ...
    ControlPanel(){
        ...
        aStar = new JRadioButton("A* - Misplaced tiles algorithm");
        aStarManhattan = new JRadioButton("A* - Manhattan Algorithm");
        aStarEuclid = new JRadioButton("A* - Euclidean Algorithm");
        bg.add(dfs);
        bg.add(bfs);
        bg.add(aStar);
        bg.add(aStarManhattan);
        bg.add(aStarEuclid);
        p2.add(dfs);
        p2.add(bfs);
        p2.add(aStar);
        p2.add(aStarManhattan);
        p2.add(aStarEuclid);
